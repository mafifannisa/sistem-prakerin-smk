...
<header class="bg-white border-b border-gray-200 px-8 py-4">
    <div>
        <h1 class="text-2xl font-bold text-gray-800">Verifikasi Jurnal Harian</h1>
        <p class="text-sm text-gray-500 mt-1">Periksa, beri catatan, dan setujui jurnal harian siswa. Riwayat jurnal tetap tercatat.</p>
    </div>
</header>
