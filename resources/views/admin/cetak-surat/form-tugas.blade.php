...
<div class="p-8 max-w-2xl mx-auto">
    ...
    <div class="mb-8 flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-extrabold text-gray-900 tracking-tight">Cetak Surat Tugas</h1>
            <p class="text-gray-500 text-xs mt-1">Isi formulir di bawah ini untuk menghasilkan Surat Tugas Siswa PDF.</p>
        </div>
    </div>

    <!-- Form Card -->
    <div class="bg-white rounded-3xl border border-gray-150 shadow-[0_10px_30px_rgba(0,0,0,0.02)] p-8">
        <form action="{{ route('admin.cetak.tugas.pdf') }}" method="POST" target="_blank" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <!-- Nomor Surat -->
                <div>
                    <label for="nomor_surat" class="block text-xs font-bold text-gray-700 uppercase tracking-wider mb-2">Nomor Surat Tugas</label>
                    <input type="text" name="nomor_surat" id="nomor_surat" value="800/SMK.3/{{ rand(100, 999) }}/{{ date('Y') }}" required class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 text-sm font-semibold text-gray-800 outline-none">
                </div>
            ...
            <!-- Keterangan Tugas -->
            <div>
                <label for="keterangan_tugas" class="block text-xs font-bold text-gray-700 uppercase tracking-wider mb-2">Keterangan Tugas</label>
                <input type="text" name="keterangan_tugas" id="keterangan_tugas" value="Melaksanakan program Praktik Kerja Industri (Prakerin)" required class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 text-sm font-semibold text-gray-800 outline-none">
            </div>

            <!-- Signature Officials Section -->
            <div class="border-t border-gray-100 pt-6">
                <h3 class="text-sm font-bold text-gray-800 mb-4">Informasi Pejabat Pemberi Tugas</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <!-- Nama Pejabat -->
                    <div>
                        <label for="nama_pemberi" class="block text-xs font-semibold text-gray-500 mb-1">Nama Kepala Sekolah</label>
                        <input type="text" name="nama_pemberi" id="nama_pemberi" value="SHOLAHUDDIN, ST., M.SI" required class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 text-sm font-semibold text-gray-800 outline-none">
                    </div>
                    <!-- NIP Pejabat -->
                    <div>
                        <label for="nip_pemberi" class="block text-xs font-semibold text-gray-500 mb-1">NIP Kepala Sekolah</label>
                        <input type="text" name="nip_pemberi" id="nip_pemberi" value="19680101 199003 1 001" required class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 text-sm font-semibold text-gray-800 outline-none">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <!-- Jabatan Pejabat -->
                    <div>
                        <label for="jabatan_pemberi" class="block text-xs font-semibold text-gray-500 mb-1">Jabatan</label>
                        <input type="text" name="jabatan_pemberi" id="jabatan_pemberi" value="Kepala SMK Negeri 3 Tuban" required class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 text-sm font-semibold text-gray-800 outline-none">
                    </div>
                    <!-- Pangkat / Golongan Pemberi -->
                    <div>
                        <label for="pangkat_pemberi" class="block text-xs font-semibold text-gray-500 mb-1">Pangkat / Golongan</label>
                        <input type="text" name="pangkat_pemberi" id="pangkat_pemberi" value="Pembina" required class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 text-sm font-semibold text-gray-800 outline-none">
                    </div>
                </div>

                <!-- Alamat Sekolah -->
                <div class="mt-4">
                    <label for="alamat_sekolah" class="block text-xs font-semibold text-gray-500 mb-1">Alamat Sekolah</label>
                    <input type="text" name="alamat_sekolah" id="alamat_sekolah" value="Jl. Bloso Ds. Temandang Kec. Merakurak Kab. Tuban" required class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 text-sm font-semibold text-gray-800 outline-none">
                </div>
            </div>
