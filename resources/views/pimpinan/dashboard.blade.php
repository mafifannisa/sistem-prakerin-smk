...
<div id="reviewModal" class="hidden fixed inset-0 bg-gray-900/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
    <div class="bg-white/95 backdrop-blur-md rounded-2xl shadow-xl w-full max-w-md overflow-hidden transform scale-95 transition-all duration-200 border border-white" id="modalContainer">
