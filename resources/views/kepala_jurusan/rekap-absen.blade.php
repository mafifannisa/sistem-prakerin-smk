...
@section('header_title', 'REKAP ABSENSI JURUSAN')
...
<div class="space-y-6">
    <div class="bg-white/80 backdrop-blur-md p-6 rounded-2xl border border-white/40 shadow-sm flex items-center justify-between flex-wrap gap-4">
        <form action="{{ route('kepala_jurusan.rekap-absen') }}" method="GET" class="flex items-center gap-3">
            <div class="relative">
            ...
            <a href="{{ route('kepala_jurusan.rekap-absen') }}" class="px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 font-semibold rounded-xl transition">
                Reset
            </a>
        </form>
    </div>
