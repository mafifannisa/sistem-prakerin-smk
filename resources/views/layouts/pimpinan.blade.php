        ...
        <aside id="sidebar" class="w-64 bg-white/85 backdrop-blur-md border-r border-gray-150 lg:border lg:border-white/40 shadow-xl lg:shadow-[0_10px_30px_rgba(0,0,0,0.04)] fixed inset-y-0 left-0 lg:left-4 lg:top-4 lg:bottom-4 z-50 h-full lg:h-[calc(100vh-2rem)] overflow-y-auto transform -translate-x-full lg:translate-x-0 transition-all duration-300 ease-in-out flex flex-col rounded-none lg:rounded-2xl">
            ...
            <nav class="p-4 space-y-1.5 flex-1 overflow-y-auto">
                ...
                <a href="{{ route('pimpinan.dashboard') }}" 
                   class="nav-item flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-250 {{ request()->routeIs('pimpinan.dashboard') ? 'sidebar-active' : 'text-gray-655 hover:bg-orange-50/50' }}">
                ...
                <a href="{{ route('pimpinan.approval.surat') }}" 
                   class="nav-item flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-250 {{ request()->routeIs('pimpinan.approval.surat') ? 'sidebar-active' : 'text-gray-655 hover:bg-orange-50/50' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                    </svg>
                    <span class="font-semibold text-sm">Approval Surat</span>
                </a>

                <a href="{{ route('pimpinan.statistik') }}" 
                   class="nav-item flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-250 {{ request()->routeIs('pimpinan.statistik') ? 'sidebar-active' : 'text-gray-655 hover:bg-orange-50/50' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                    </svg>
                    <span class="font-semibold text-sm">Statistik</span>
                </a>

                <a href="{{ route('pimpinan.laporan') }}" 
                   class="nav-item flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-250 {{ request()->routeIs('pimpinan.laporan') ? 'sidebar-active' : 'text-gray-655 hover:bg-orange-50/50' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                    </svg>
                    <span class="font-semibold text-sm">Pusat Laporan</span>
                </a>
            </nav>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex flex-col">
                            <div class="flex items-center gap-1.5 text-[10px] font-extrabold text-gray-400 uppercase tracking-widest mb-0.5">
                                ...
                                <span class="text-orange-500">@yield('header_breadcrumb', 'Pimpinan')</span>
                            </div>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div class="relative">
                                <button onclick="toggleUserDropdown()" class="w-10 h-10 bg-gradient-to-tr from-orange-500 to-amber-400 rounded-full flex items-center justify-center text-white font-bold shrink-0 shadow-sm border border-white hover:scale-105 active:scale-95 transition-all duration-200">
                                    {{ substr(Auth::user()->nama_lengkap ?? 'P', 0, 2) }}
                                </button>
                                    ...
                                    <div class="p-5 border-b border-gray-100 bg-gradient-to-br from-orange-50/30 to-orange-100/10">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                ...
                                                <p class="text-[10px] text-gray-400 font-semibold uppercase">Pimpinan / Kepala Sekolah</p>
                                            </div>
                                        </div>
                                    </div>
